...
import com.principal.paarambha.domain.EmployeeDataOnDemand;
...
privileged aspect EmployeeDataOnDemand_Roo_DataOnDemand {
    ...
    public void EmployeeDataOnDemand.setBuddy(Employee obj, int index) {
        String buddy = "buddy_" + index;
        obj.setBuddy(buddy);
    }
    
    public void EmployeeDataOnDemand.setDateOfBirth(Employee obj, int index) {
    ...
    public void EmployeeDataOnDemand.setEmailId(Employee obj, int index) {
    ...
    public void EmployeeDataOnDemand.setPhoneNumber(Employee obj, int index) {
